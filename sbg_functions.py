...
def SBG_signal(
    ...
    """ Generate the bubble field, simulate bubble movement with respect to 
        ...
        compressed_signal  (str): Compress signal (True/False)
    ...
    for ii in range(n_chunk):
        ...
        if (start_idx_bubbles >= 0) & (end_idx_bubbles >= start_idx_bubbles):
