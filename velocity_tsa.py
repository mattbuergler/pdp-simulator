...
log10_first = 1
resampling_frequencies = np.logspace(log10_first,math.log10(ts_frequency),int(math.log10(ts_frequency)))
...
log10_first = 1
resampling_frequencies = np.logspace(log10_first,math.log10(ts_frequency),int(math.log10(ts_frequency)))
fig, axs = plt.subplots(ncols=len(resampling_frequencies),figsize=(len(resampling_frequencies)*2.5,4))
...
plt.text(8,3.7,r'$T_L$ = {}s'.format(T_L[0]),fontsize=fs2)
plt.text(8,3.3,r'$dt$ = {}s'.format(1.0/ts_frequency),fontsize=fs2)
plt.text(8,2.9,r'$T_L/dt$ = {}'.format(int(T_L[0]*ts_frequency)),fontsize=fs2)
plt.tight_layout()
